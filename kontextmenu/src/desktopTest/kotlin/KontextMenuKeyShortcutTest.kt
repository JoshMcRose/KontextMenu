...
class KontextMenuKeyShortcutTest {
    ...
    fun `test ContextMenuKeyShortcut creation`() {
        ...
        // Assert
        assertEquals(Key.Companion.X, shortcut.key)
    ...
    fun `test ContextMenuKeyShortcut getKeyStroke with all modifiers`() {
        ...
        assertTrue(
            lowerKeyStroke.contains("ctrl") || lowerKeyStroke.contains("⌃"),
            "KeyStroke should include Ctrl modifier"
        )
        assertTrue(
            lowerKeyStroke.contains("meta") || lowerKeyStroke.contains("⌘") || lowerKeyStroke.contains("win"),
            "KeyStroke should include Meta modifier"
        )
        assertTrue(
            lowerKeyStroke.contains("alt") || lowerKeyStroke.contains("⌥"),
            "KeyStroke should include Alt modifier"
        )
        assertTrue(
            lowerKeyStroke.contains("shift") || lowerKeyStroke.contains("⇧"),
