...
class ContextMenuKeyShortcutTest {
    ...
    fun `test ContextMenuKeyShortcut getKeyText`() {
        // Arrange
        val shortcut = ContextMenuKeyShortcut(key = Key.X)
    ...
    fun `test ContextMenuKeyShortcut equals and hashCode`() {
        // Arrange
        val shortcut1 = ContextMenuKeyShortcut(
            key = Key.X,
            ctrl = true,
            meta = false,
            alt = true,
        ...
        val shortcut2 = ContextMenuKeyShortcut(
            key = Key.X,
            ctrl = true,
            meta = false,
            alt = true,
        ...
        val shortcut3 = ContextMenuKeyShortcut(
            key = Key.Y,
            ctrl = true,
            meta = false,
            alt = true,
